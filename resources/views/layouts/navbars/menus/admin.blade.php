<ul class="navbar-nav">
    @if (!config('app.isqrsaas'))
                ...
                <li class="nav-item">
                    <a class="nav-link" target="_blank" href="{{ url('/admin/languages')."/".strtolower(env('APP_LOCALE','EN'))."/translations".(config('app.isqrsaas')?"?group=qrlanding":"") }}">
                ...
                @if (env('is_demo',false))
                    <li class="nav-item">
                        <a class="nav-link" target="_blank" href="#">
                            <i class="ni ni-active-40 text-yellow"></i> {{ __('ENV Editor') }} ( {{__('disabled in demo') }} )
                        </a>
                    </li>
                @else
                    <li class="nav-item">
                        <a class="nav-link" target="_blank" href="{{ url('admin/env') }}">
                            <i class="ni ni-active-40 text-yellow"></i> {{ __('ENV Editor') }}
                        </a>
                    </li>
                @endif
