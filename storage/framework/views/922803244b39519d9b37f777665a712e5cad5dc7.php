                ...
                <div class="card bg-secondary shadow border-0">
                    <div class="card-body px-lg-5 py-lg-5">
                        <form id="form-assing-driver" method="GET" action="">
                            <div class="form-group<?php echo e($errors->has('driver') ? ' has-danger' : ''); ?>">
                                <label class="form-control-label" for="driver"><?php echo e(__('Assign Driver')); ?></label>
...
<?php /**PATH /Users/danieldimov/Documents/Projects/Mobidonia/CodeCanyon/MRestorant/Site/resources/views/orders/partials/modals.blade.php ENDPATH**/ ?>