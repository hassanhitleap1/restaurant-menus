  ...
  <div class="container-fluid">
      ...
      <div class="navbar-collapse collapse" id="navbar_global">
        ...
        <ul class="navbar-nav align-items-lg-center ml-lg-auto">
          <?php if(!env('SINGLE_MODE',false)): ?>
            <li class="nav-item">
              <a data-mode="popup" target="_blank" class="button nav-link nav-link-icon" href="<?php echo e(route('newrestaurant.register')); ?>"><?php echo e(__('Register your restaurant')); ?></a>
            </li>
          <?php endif; ?>
...
<?php /**PATH /Users/danieldimov/Documents/Projects/Mobidonia/CodeCanyon/MRestorant/Site/resources/views/layouts/menu/top.blade.php ENDPATH**/ ?>