        ...
        <div class="row">
            <div class="col-md-4">
                ...
                <form action="<?php echo e(route('front')); ?>">
                    ...
                    <div class="col-md-4">
                        <button type="submit" class="btn btn-danger"><?php echo e(__('Find restaurants')); ?></button>
                    </div>
                </form>
...
<?php /**PATH /Users/danieldimov/Documents/Projects/Mobidonia/CodeCanyon/MRestorant/Site/resources/views/layouts/headers/search.blade.php ENDPATH**/ ?>