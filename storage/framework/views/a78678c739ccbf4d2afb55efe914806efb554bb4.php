    ...
    <div class="modal-dialog modal-lg modal-dialog-centered modal-large" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" id="submitNewAddress" onclick="this.disabled=true;this.form.submit();"   class="btn btn-outline-success"><?php echo e(__('Save')); ?></button>
              </div>
...
<?php /**PATH /Users/danieldimov/Documents/Projects/Mobidonia/CodeCanyon/MRestorant/Site/resources/views/clients/modals.blade.php ENDPATH**/ ?>